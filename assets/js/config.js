...
export const CONFIG = {
    ...
    VALID_URL_REGEX: /^https:\/\/(github\.com|gist\.githubusercontent\.com)\/([\w-]+)\/([\w-]+)(\/releases\/download|\/archive\/refs\/heads|\/archive\/refs\/tags|\/blob|\/raw)\/([\w\.-]+)(\/[\w\.-]+)?(\?.*)?$/, // 更新正则表达式以支持更多 URL 模式
    FILE_TYPES: {
